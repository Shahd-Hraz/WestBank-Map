...
const westBank2024 = L.esri.dynamicMapLayer({
    url: "https://orthophotos.geomolg.ps/adaptor/rest/services/Orthophotos_WB_2024_15cm_tif_PG1923/MapServer",
    opacity: 1
});
const gazaOrthophoto = L.esri.dynamicMapLayer({
    url: "https://orthophotos.geomolg.ps/adaptor/rest/services/Orthophotos_GS_2025_m03_Satellite_tif_PG1923/MapServer",
    opacity: 1
});
 5
...
const overlayMaps = {
    ...
    "WestBank Orthophoto 2024": westBank2024,
    "Gaza Strip Orthophoto 2024": gazaOrthophoto
};
